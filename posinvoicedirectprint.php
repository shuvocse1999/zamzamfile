    ...
    <div class="page-wrapper">
        <div class="invoice-card">
            <div class="invoice-head">
             <center>
                ...
                <p class="my-0"><?php echo $storeinfo->address;?><br>Mobile: 01770-702446</p>
            </center>
        </div>
        ...
        <div class="invoice-details">
            <div class="invoice-list">
               ...
               <div class="row-data">
                <div class="item-info">
                    <h5 class="item-title"><?php echo $item->ProductName;?> - <?php echo $item->variantName;?></h5>
                </div>

                <h5 class="item-size"><?php echo $item->menuqty;?></h5>
                <h5 class="item-number"><?php echo $singleprice;?></h5>
...
<div class="text-center">
    <p class="b_top" style="font-size: 15px; line-height: 20px; color: #000; font-weight: bold; letter-spacing: 0.5px;">Develop By Software Farm BD.<br>
